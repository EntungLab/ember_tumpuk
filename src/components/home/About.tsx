        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              Ember tumpuk adalah alat sederhana yang digunakan untuk mengolah sampah organik menjadi pupuk cair dan kompos padat melalui proses fermentasi. Komposter ini terdiri dari dua atau tiga ember yang disusun secara vertikal, dengan ember atas berfungsi sebagai wadah utama untuk menampung sampah organik, sementara ember bawah berfungsi sebagai tempat penampungan pupuk cair atau lindi.
            </p>
            ...
            <div className="pt-6">
              ...
              >
                <div className="p-6 bg-green-50 rounded-lg">
                  <h4 className="text-xl font-bold text-green-800 mb-2">27+</h4>
                  <p className="text-gray-600">Pengguna Aktif</p>
                </div>
                <div className="p-6 bg-green-50 rounded-lg">
                  <h4 className="text-xl font-bold text-green-800 mb-2">2kg+</h4>
                  <p className="text-gray-600">Sampah Diolah per Bulan</p>
                </div>
              </motion.div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-green-600 text-white px-8 py-3 rounded-full hover:bg-green-700 transition-colors mt-4"
              >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                year: 'Feb 2025',
                title: 'Pengenalan',
                description: 'workshop kepada masyarakt di purborejo',
              },
              {
                year: 'Feb 2025',
                title: 'penerapan',
                description: 'Penerapan di rumah rumah',
              },
            ].map((item, index) => (
              <motion.div
                key={index}
